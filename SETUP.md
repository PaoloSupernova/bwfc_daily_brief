...
> **Skip steps 5–11 if you are restoring from a database export** — see Part 2 (Data Transfer) instead.
...
> Linux server, ensure that folder is writable by the web server user.
